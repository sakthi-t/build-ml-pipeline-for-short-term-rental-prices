...
def go(args):
    ...
    model_export_artifact.metadata = {'rf_config': rf_config}

    # Add the directory containing the model files to the artifact
...
def get_inference_pipeline(rf_config, max_tfidf_features):
    ...
    ('onehot', OneHotEncoder())  # Step 2: One-hot encode the variable
    ])
    ######################################
